...
import me.edagarli.invisiblelovers.db.InviteMessgeDao;
import me.edagarli.invisiblelovers.db.UserDao;
import me.edagarli.invisiblelovers.domain.InviteMessage;
import me.edagarli.invisiblelovers.domain.User;
import me.edagarli.invisiblelovers.ui.LoginActivity;
...
public class MainActivity extends BaseActivity {
	...
	public int getUnreadAddressCountTotal() {
		...
		if (InvisibleLoversApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = InvisibleLoversApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
...
//			message.getStringAttribute("");
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Map<String, User> localUsers = InvisibleLoversApplication.getInstance().getContactList();
	...
	private void saveInviteMsg(InviteMessage msg) {
		...
		// 未读数加1
		User user = InvisibleLoversApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME);
	...
	private void showConflictDialog() {
        ...
        InvisibleLoversApplication.getInstance().logout(null);
