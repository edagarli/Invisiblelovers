...
import me.edagarli.invisiblelovers.model.DefaultHXSDKModel;
import me.edagarli.invisiblelovers.model.HXSDKModel;
...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        // create HX SDK me.edagarli.invisiblelovers.model
        hxModel = createModel();
        
        // create a defalut HX SDK me.edagarli.invisiblelovers.model in case subclass did not provide the me.edagarli.invisiblelovers.model
        if(hxModel == null){
    ...
    /**
     * the subclass must override this class to provide its own me.edagarli.invisiblelovers.model or directly use {@link DefaultHXSDKModel}
     * @return
     */
